...
@State(name = "HadoopNavigator.Project.Settings",
        storages = {@com.intellij.openapi.components.Storage(value = "$PROJECT_CONFIG_DIR$/hdfsnavigator.xml"/*,
                scheme = com.intellij.openapi.components.StorageScheme.DIRECTORY_BASED*/),
                @com.intellij.openapi.components.Storage(value = "$PROJECT_FILE$")})
public class ProjectSettingsManager implements NamedComponent, Disposable, PersistentStateComponent<Element>
{
